...
public class Step01VariableTest extends PlainTestCase {
    ...
    public void test_variable_reassigned_BigDecimal() {
        ...
        // done jflute 次回1on1にて、immutable/mutableのメリデメ思考トレーニング (2026/07/28)
        //
        // immutableのメリット:
        // o 変えちゃいけないものを変えられないようにする → 安全性
        // o immutableは(読み手にとっての)情報なので、読みやすくなる。
        //   (読み飛ばしなど) → 可読性
        //
        // immutableのデメリット:
        // $ o ケースバイケースで使い分けないといけないので、使いづらいこともあるかも？ by はっとりさん
        //  → 使い分けの判断コスト
        //  → immutableは手間を掛けてimmutableしてる (言語の文法に寄る)
        // $ o カウントアップはできない？ by はっとり
        //  → 厳密にはカウントアップできなくはないが...
        //  → $ メモリが無駄なような
        //
        // immutableの歴史:
        // o 昔は、PCがメモリ貧弱だったので、new/newするのはちょっと抵抗ある
        // o 昔は、言語文法も貧弱だったので、immutableやろうとすると手間が掛かりやすい
        // o 今は、どっちも進化して、そこまで気にならなくなってきた
        //
        // immutableのバランス:
        // o 言語や組織や個人に寄る
        // o Java: 歴史的なこともあるし、コンセプトもあるし、なので8:2くらいでimmutable頑張るけど無理しない
        //  i mutable使う時は、mutableのデメリットが顕在化しないように別の手段で工夫する
        //  i 安全性と可読性を演出する手段は、immutableだけじゃない
        //  i jflute個人的にそんな感覚でJava書いてる
        // o 他の言語だと、100%寄りの言語もある。
    }
    ...
    private void helpInstanceVariableViaMethod(String instanceMagiclamp) {
        ...
        // done jflute 次回1on1にて、サクッとふぉろー (2026/07/28)
    }
